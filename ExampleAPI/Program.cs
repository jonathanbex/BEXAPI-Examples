...
namespace ExampleAPI
{
  class Program
  {
    async static void Main(string[] args)
    {
      ...
      //Base path of api
      var baseUrl = "https://bexapi.azure-api.net/api/";
      ...
      //Either use a fixed value or choose one from the method https://bexapi.developer.azure-api.net/api-details#api=bex-api&operation=WarehouseManagement_GetLocations
      var location = "";
